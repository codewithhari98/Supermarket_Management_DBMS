...
<%
	try {
		...
		String sql = "SELECT CATEGORY,COUNT(CATEGORY) as count FROM S22_S003_13_PRODUCT P, S22_S003_13_CONTAINS C WHERE P.PRODUCT_ID=C.PRODUCT_ID GROUP BY CATEGORY order by count desc";
