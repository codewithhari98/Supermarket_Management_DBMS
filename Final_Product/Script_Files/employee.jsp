...
<form action="promote_employee.jsp"method "post">
		<input type="submit" class="button" value="Promote_Employee">
</form>


<div class="header">
		<h1>Below Are The Employee Details</h1>
	</div>
	<%
try {
	...
	ResultSet rs = st.executeQuery("Select * from S22_S003_13_EMPLOYEE");
	while (rs.next()) {
		%>
	<table align='center' border='1' width="100" style="width: 100%"
		...
		<tbody>
			<tr>
				...
				<th width="25%">MIDDLE_NAME</th>
				<th width="25%">LAST_NAME</th>
				<th width="25%">EMPLOYEE_DEPARTMENT_ID</th>
